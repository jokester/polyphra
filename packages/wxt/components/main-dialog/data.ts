...
export const mockResponses: Record<string, string> = {
  ...
  sherlock:
    `Elementary observation: "{text}" - a statement that, upon careful analysis, reveals the logical conclusion that the speaker possesses a methodical approach to communication.`,
  yoda: `"{text}", you say. Hmm. Wise words these are, yes. Much to learn from this, there is.`,
  gatsby:
    `Old sport, "{text}" - why, that's simply marvelous! It reminds me of those golden summer evenings when hope danced like fireflies across the bay.`,
  churchill:
    `"{text}" - Indeed, this statement embodies the very spirit of determination that shall guide us through our darkest hours toward the dawn of victory!`,
};
